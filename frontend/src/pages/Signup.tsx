...
const Signup = () => {
  ...
  // Google button visibility — controlled by admin toggle
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.error) {
      ...
      toast.success("Account created! Welcome to FOOVA FOODS!");
      navigate("/");
    }
  };
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 pt-20 pb-10">
      ...
      >
        ...
        {/* Google Sign In — only shown when admin enables it */}
        {googleEnabled && (
          <>
            <button
